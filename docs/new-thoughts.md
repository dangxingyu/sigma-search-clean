...
- The transition region should be described as noisy/tie-like rather than monotone: 1M has a tiny LR-closed `c=0.5` edge, 2M over five seeds is near-tie (`+0.0005 ± 0.0042` SEM for `c=0.5 - identity`), and 4M favors `c=0.5` in seed42 pending seed confirmation.
