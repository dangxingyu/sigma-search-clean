...
Latest update:
- 2026-05-16 handoff simplification: changed default optimizer-baseline groups to `plain_muon adamw kl_shampoo`. `plain_muon` no longer runs an LR grid by default; it runs exactly one LR per requested d12/d16 batch, copied from the previous alpha=`1.0` best rows: d12 `{512K:0.0075, 2M:0.015, 8M:0.01}` and d16 `{512K:0.005, 2M:0.005, 8M:0.015}`. `shampoo`, `soap`, and `kl_soap` remain implemented but are opt-in.
