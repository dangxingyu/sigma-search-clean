...
- Next required result: rerun at least a small d8/d12 sanity grid before interpreting SOAP/Shampoo/KL-SOAP quality. Updated configs are vanilla SOAP `beta1=0.95`, `beta2=0.99`, `shampoo_beta=0.95`, `precondition_frequency=10`; Shampoo/KL-Shampoo `beta1=0.9`, `beta2/shampoo_beta=0.98`, `precondition_frequency=10`, `structured_init_factor=0.1`; and PR-290 KL-SOAP-H-style `beta1=0.95`, `beta2=0.9`, `shampoo_beta=0.9`, `precondition_frequency=1`, `structured_init_factor=0.1`; baseline wrappers now default `WEIGHT_DECAY=0.1`.
