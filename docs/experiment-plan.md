...
- Use reference-aligned configs for structured methods, with one handoff simplification: SOAP keeps the vanilla recipe `beta1=0.95`, `beta2=0.99`, `shampoo_beta=0.95`, `precondition_frequency=10`; Shampoo and KL-Shampoo both use the KL-Shampoo prototype-style beta recipe `beta1=0.9`, `beta2=0.98`, `shampoo_beta=0.98`, `precondition_frequency=10`, `structured_init_factor=0.1`; KL-SOAP-style uses `beta1=0.95`, `beta2=0.9`, `shampoo_beta=0.9`, `precondition_frequency=1`, `structured_init_factor=0.1`.
